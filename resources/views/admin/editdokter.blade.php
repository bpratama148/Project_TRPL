                     ...
                     <div class="row">
                      ...
                      <section class="panel">
                            ...
                            <div class="panel-body">
                                     ...
                                     <form class="form-horizontal form-bordered"  method="POST" action="/dokter/{{$dokter->id}}/update" enctype="multipart/form-data">
                                        @csrf
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="judul" >Nama  Dokter</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control"  id="name"  value="{{$dokter->name}}" 
                                                     name="name" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="profesi"
                                                     value="{{$dokter->profesi}}"  name="profesi">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" id="bidang"
                                                     name="bidang" value="{{$dokter->bidang}}" >
                                                </div>
                                           </div>
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <input type="text" class="form-control" id="kontak"
                                                     name="kontak" value="{{$dokter->kontak}}" >  
                                                </div>
                                            </div>
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <input type="text" class="form-control" id="alamat"
                                                     name="alamat" value="{{$dokter->alamat}}" >  
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <input type="password" class="form-control" id="password"
                                                     name="password" value="{{$dokter->password}}" >  
                                                </div>
                                            </div>
