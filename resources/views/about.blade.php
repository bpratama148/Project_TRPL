                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/daftar">Sign Up</a></li> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <a href="" class="main_btn">Sign Up and Join Us Now</a>
                    <a href="" class="main_btn_light">Sign In If You Have an Account</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-feature text-center text-lg-left">
                            ...
                            </span>Online Discussing Forum </h3>
                            <p class="card-feature__subtitle">An so vulgar to on points wanted rapture ous resolving continued household </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card-service text-center text-lg-left mb-4 mb-lg-0">
                        ...
                        <h3 class="card-service__title">Recommended Diet Program</h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-service text-center text-lg-left mb-4 mb-lg-0">
                        ...
                        <h3 class="card-service__title">Fitness Schedule</h3>
                        <p class="card-service__subtitle">Land meat winged called subdue without a very light in all years sea appear Lesser bring fly first land set female best perform</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-service text-center text-lg-left mb-4 mb-lg-0">
                        ...
                        <h3 class="card-service__title">Advice and Suggestion From The Experts</h3>
                        <p class="card-service__subtitle">Land meat winged called subdue without a very light in all years sea appear Lesser bring fly first land set female best perform</p>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="{{url('aa/img/team/1.jpg')}}" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="{{url('aa/img/team/2.jpg')}}" alt="">
                        <div class="card-team__body text-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card card-team">
                        <img class="card-img rounded-0" src="{{url('aa/img/team/3.jpg')}}" alt="">
                        <div class="card-team__body text-center">
                            <h3><a href="#">Dr Blian Judge</a></h3>
                            <p>Cardiologist</p>
                            <div class="team-footer d-flex justify-content-between">
                ...
                <div class="item">
                    <div class="testi_item">
                        <div class="testimonial_image">
                            <img src="{{url('aa/img/elements/tes1.jpg')}}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{url('aa/img/blog/1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{url('aa/img/blog/2.jpg')}}" alt="">
                        </div>
                        <div class="short_details">
                            <div class="meta-top d-flex">
                                <a href="#">medical, </a>
                ...
                <div class="col-md-6 col-lg-4 col-md-4">
                    <div class="single-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{url('aa/img/blog/3.jpg')}}" alt="">
                        </div>
                        <div class="short_details">
                            <div class="meta-top d-flex">
                                <a href="#">medical, </a>
                    ...
                    <div class="owl-carousel brand-carousel">
                        ...
                        <div class="single-brand-item d-table">
                            <div class="d-table-cell">
                                <img src="{{url('aa/img/brand/1.png')}}" alt="">
                            </div>
                        </div>
                        <!-- single-brand -->
                        <div class="single-brand-item d-table">
                            <div class="d-table-cell">
                                <img src="{{url('aa/img/brand/2.png')}}" alt="">
                            </div>
                        </div>
                        <!-- single-brand -->
                        <div class="single-brand-item d-table">
                            <div class="d-table-cell">
                                <img src="{{url('aa/img/brand/3.png')}}" alt="">
                            </div>
                        </div>
                        <!-- single-brand -->
                        <div class="single-brand-item d-table">
                            <div class="d-table-cell">
                                <img src="{{url('aa/img/brand/4.png')}}" alt="">
                            </div>
                        </div>
                        <!-- single-brand -->
                        <div class="single-brand-item d-table">
                            <div class="d-table-cell">
                                <img src="{{url('aa/img/brand/5.png')}}" alt="">
                            </div>
                        </div>
                        <!-- single-brand -->
                        <div class="single-brand-item d-table">
