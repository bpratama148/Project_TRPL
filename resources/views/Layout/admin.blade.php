...
<html class="fixed">
	<head>
		...
		<link rel="stylesheet" href="{{url('assets/vendor/summernote/summernote-bs3.css')}}" />
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="{{url('assets/images/logo.png')}}" height="35" alt="JSOFT Admin')}}" />
					</a>
